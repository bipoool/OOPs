<?php
    ...
    // $form->addRadioField(array("name"=>"radio", "id"=>"1", "class"=>"form-radio", "value"=>"1"), "radio 2", array("class"=>"label-lg"));
    // $form->addRadioField(array("name"=>"radio", "id"=>"2", "class"=>"form-radio", "value"=>"2"), "radio 1", array("class"=>"label-lg"));
    ...
    $dbform = new DB_Forms("Users");
    $dbform->validateAndAdd();
